...
export default function AddGarnishClient() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("/api/garnishes", {
                method: "POST",
            ...
            if (!res.ok) {
                ...
                throw new Error(text || "Failed to add garnish")
            }
                    ...
                    <div className="bg-[#1a1b21] border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
                        <div className="p-6 border-b border-white/5 flex justify-between items-center">
                            <h3 className="text-xl font-bold flex items-center gap-2">
                                <i className="ph-fill ph-leaf text-[#00d2ff]"></i>
                                Add New Garnish
                            </h3>
